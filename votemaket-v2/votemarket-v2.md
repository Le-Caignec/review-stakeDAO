...
### L1Sender
 ...
 Rôle
 • Envoyer depuis L1 vers L2 des informations de bloc (block number, block hash, timestamp).
...
Rôle
 • Sur L2, réceptionne le bloc hash/number/time envoyé depuis L1 (par L1Sender) et l’insère dans l’Oracle approprié.

Fonctionnement

 1. updateL1BlockNumber
